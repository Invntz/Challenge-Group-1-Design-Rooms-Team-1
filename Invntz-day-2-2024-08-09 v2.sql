#Created by Dhilan Thiyagarajah using drawSQL

CREATE TABLE "production"(
    "production_bavarchartch_ID" INT NOT NULL,
...
ALTER TABLE
    "production" ADD CONSTRAINT "production_production_bavarchartch_id_primary" PRIMARY KEY("production_bavarchartch_ID");
...
ALTER TABLE
    "news_category" ADD CONSTRAINT "news_category_new_category_id_primary" PRIMARY KEY("new_category_id");
...
ALTER TABLE
    "news_feed" ADD CONSTRAINT "news_feed_news_category_id_foreign" FOREIGN KEY("news_category_id") REFERENCES "news_category"("new_category_id");
ALTER TABLE
...
ALTER TABLE
    "news_feed" ADD CONSTRAINT "news_feed_manufacturer_id_foreign" FOREIGN KEY("manufacturer_id") REFERENCES "manufacturer"("manufacturer_id");
ALTER TABLE
