#Created by Dhilan_Thiyagarajah using drawSQL
...
ALTER TABLE
    "news_feed" ADD CONSTRAINT "news_feed_news_idvarchar_primary" PRIMARY KEY("news_idvarchar");
